        ...
        public void initandPositionDropdowns(){
            ...
            if(Support.b.curobjective == "Total Daily Profit" && Support.b.curobjective!=Support.b.lastobjective){
                ...
                string[] tmp = new string[Support.b.ddItemStrings.GetLongLength(1)];
                        ...
                        menuNumtickers[0] = new Gui.NumTicker(new Vector2f(menuDropDowns[0].backing.Position.X,menuDropDowns[0].Position.Y +menuDropDowns[0].GetGlobalBounds().height+100),int.Parse(new Support.b.objSettings[0,2,1]],30000,1000,Support.b.objsettings[0,2,0],0));
